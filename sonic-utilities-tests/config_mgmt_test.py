...
class TestConfigMgmt(TestCase):
    ...
    def test_extra_lock_tables_cases(self):
    ...
    def test_verifyAppDB_call(self):
        ...
        fargs = cmdpb._verifyAppDB.call_args_list[0].kwargs
        print(fargs)
        assert len(fargs) == 3
        assert fargs['ports'] == dPorts
        return
    ...
    def test_verifyAppDB_success(self):
        ...
        # Bit of hack here, we use ConfigDBConnector to connect to APPL_DB
        ...
        # get dPorts
        dPorts, _, _ = self.generate_args(portIdx=8, laneIdx=73, \
